...
function buildBundleCompatibilityShimShell(): string {
  return [
    ...
    '      echo \'{"event":"fast_restore.missing_compatibility_source","shim":"agents/auth-profiles.runtime.js","source":"auth-profiles"}\' >&2',
    '      exit 1',
    '    fi',
    ...
    '      echo \'{"event":"fast_restore.missing_compatibility_source","shim":"plugins/provider-discovery.runtime.js","source":"provider-discovery.runtime.js"}\' >&2',
    '      exit 1',
    '    fi',
...
The script saves PNG images to disk and prints \`MEDIA:\` lines with workspace-relative paths (one per line).
...
function toMediaReference(filePath) {
...
for (const f of saved) console.log("MEDIA:" + toMediaReference(f));
